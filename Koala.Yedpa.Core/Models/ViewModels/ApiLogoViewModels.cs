...
namespace Koala.Yedpa.Core.Models.ViewModels
{
    ...
    {
        /// <summary>
        /// Cari kart Referansı (LogicalRef)
        /// </summary>
        [SwaggerSchema(Description = "Cari kart Referansı (LogicalRef)")]
        public int LogicalRef { get; set; }
        /// <summary>
        /// Cari Kart kodu
        /// </summary>
        [SwaggerSchema(Description = "Cari Kart kodu")]
        public string ClCode { get; set; }
        /// <summary>
        /// Cari kart Açıklaması
        /// </summary>
        [SwaggerSchema(Description = "Cari kart Açıklaması")]
        public string ClDefinition { get; set; }
        /// <summary>
        /// Son fatura tarihi
        /// </summary>
        [SwaggerSchema(Description = "Son fatura tarihi")]
        public DateTime? LastInvoiceDate { get; set; }
        /// <summary>
        /// Son ödeme yaptığı tarih
        /// </summary>
        [SwaggerSchema(Description = "Son ödeme yaptığı tarih")]
    ...
    public class ClCardStatementViewModel
    {
        public int Logicalref { get; set; }
        public string ClCode { get; set; }
        public string ClDefinition { get; set; }
        public List<ClCardStatementReceiptsViewModel> Receipts { get; set; }=new List<ClCardStatementReceiptsViewModel>();

    }

    public class ClCardStatementReceiptsViewModel
    {
        public DateTime ReceiptDate { get; set; }
        public string ReceiptNo { get; set; }
        public int ReceiptTypeNo { get; set; }
