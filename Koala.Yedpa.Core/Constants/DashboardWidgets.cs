namespace Koala.Yedpa.Core.Constants
{
    ...
    public static class DashboardWidgets
    {
        public static readonly List<DashboardWidgetDefinition> All = new()
        {
            ...
            new() { Id = "W11", Title = "Aidat Tahsilat Durumu", Claim = "BudgetManagement", PartialView = "_WidgetAidatTahsilatDurumu", DefaultX = 0, DefaultY = 13, DefaultWidth = 12, DefaultHeight = 3, DefaultVisible = true },
            new() { Id = "W3", Title = "Vadesi Geçen Ödemeler", Claim = "CurrentAccuant", PartialView = "_WidgetOverduePayments", DefaultX = 0, DefaultY = 16, DefaultWidth = 6, DefaultHeight = 3, DefaultVisible = false },
            new() { Id = "W6", Title = "Son İşlemler", Claim = "CurrentAccuant", PartialView = "_WidgetRecentTransactions", DefaultX = 6, DefaultY = 16, DefaultWidth = 6, DefaultHeight = 4, DefaultVisible = false },
            new() { Id = "W9", Title = "Yıllık Bütçe Karşılaştırma", Claim = "BudgetManagement", PartialView = "_WidgetYearlyBudget", DefaultX = 0, DefaultY = 20, DefaultWidth = 12, DefaultHeight = 4, DefaultVisible = false },
            new() { Id = "W10", Title = "Aktif Dükkan Sayısı", Claim = "Management", PartialView = "_WidgetShopCount", DefaultX = 0, DefaultY = 24, DefaultWidth = 3, DefaultHeight = 2, DefaultVisible = false }
        };
    }
}
