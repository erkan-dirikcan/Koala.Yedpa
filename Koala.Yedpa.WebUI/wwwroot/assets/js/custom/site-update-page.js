...
var ClcSiteUpdate = function () {
    ...
    var calculateTotals = function () {
        ...
        $('#TotalNetMetre').val(netMetreTotal.toFixed(2));
        $('#TotalBrutCoefficientMetre').val(brutCoeffTotal.toFixed(2));
        $('#TotalFuelMetre').val(fuelTotal.toFixed(2));
    };
